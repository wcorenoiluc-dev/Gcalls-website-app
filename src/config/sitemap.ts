...
export const SITEMAP: SitemapEntry[] = [
  ...
  },
  {
    ...
    eyebrow: 'Sản phẩm',
    title: 'QA QC Center | QC Bot AI kiểm soát chất lượng cuộc gọi | Gcalls',
    exactTitle: true,
    description:
      'QA QC Center (QC Bot AI) hỗ trợ chuyển hội thoại thành dữ liệu để đội QA đánh giá và kiểm soát chất lượng cuộc gọi.',
    intro:
